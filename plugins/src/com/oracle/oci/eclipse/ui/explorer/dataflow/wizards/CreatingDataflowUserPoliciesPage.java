package com.oracle.oci.eclipse.ui.explorer.dataflow.wizards;
 ...
 public class CreatingDataflowUserPoliciesPage extends WizardPage{

 	public CreatingDataflowUserPoliciesPage(ISelection selection, String COMPARTMENT_ID) {
 		super("wizardPage");
 		setTitle("Identity: Data Flow user policies setup");
 		setDescription("This page creates the required IAM policies to allow Dataflow admins to manage applications and runs");
 	}
     ...
     public void createControl(Composite parent) {
 		...
 		policy1.setText("ALLOW GROUP dataflow-admin TO READ buckets IN tenancy");
 		...
 		policy2.setText("ALLOW GROUP dataflow-admin TO MANAGE dataflow-family IN tenancy");
 		...
 		policy3.setText("ALLOW GROUP dataflow-admin TO MANAGE objects IN tenancy WHERE ALL\n"
 		...
 		note.setText("Note: Make sure dataflow-admin user group already exists");
